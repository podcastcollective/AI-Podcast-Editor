...
- STUMBLE RECONSTRUCTION: When a speaker stumbles through a passage with multiple restarts and false starts, do NOT make individual cuts for each problem. Instead: (1) Identify the full stumbled region. (2) Work out what the speaker INTENDED to say — the clean sentence that uses their actual words. (3) Identify which specific words in the transcript form that clean sentence. (4) Make cuts that remove ONLY the abandoned/repeated words between the keeper words, producing the intended clean sentence. Example: speaker says "it's certainly very disruptive in terms of. It's certainly disruptive. It's certainly very disruptive and it'll be interesting..." — the intended sentence is "it's certainly very disruptive and it'll be interesting..." — so cut everything from "in terms of" through to the final "it's certainly very disruptive", keeping only the last clean version. This should be ONE continuous cut from the end of the last good word before the stumble to the start of where the clean version picks up.
